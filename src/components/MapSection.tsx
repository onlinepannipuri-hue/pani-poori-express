const MapSection = () => (
  <section className="py-16 bg-muted/40">
    <div className="container">
      <h2 className="text-3xl md:text-4xl font-display font-bold text-center mb-2">📍 Delivery Area</h2>
      <p className="text-center text-muted-foreground mb-8">We deliver within 5 KM radius in Chennai</p>
      <div className="rounded-lg overflow-hidden shadow-card max-w-3xl mx-auto aspect-video">
        <iframe

  ...
  return (
    <section id="menu" className="py-16 bg-muted/40">
      <div className="container">
        <h2 className="text-3xl md:text-4xl font-display font-bold text-center mb-2">Our Menu</h2>
        <p className="text-center text-muted-foreground mb-10">Freshly made with love, delivered to your door 🚀</p>

        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-6">
          {menuItems.map((item) => (
            <div key={item.id} className="group bg-card rounded-lg overflow-hidden shadow-card hover:shadow-card-hover transition-all duration-300 hover:-translate-y-1">

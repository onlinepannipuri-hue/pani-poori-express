...
const ReviewsSection = () => (
  <section id="reviews" className="py-16 bg-muted/40">
    <div className="container">
      <h2 className="text-3xl md:text-4xl font-display font-bold text-center mb-2">⭐ What Customers Say</h2>
      <p className="text-center text-muted-foreground mb-10">100+ Happy Customers and counting!</p>
